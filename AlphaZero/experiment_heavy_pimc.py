...
from AlphaZero.AlphaZeroPlayer.heavy_pimc_player import Heavy_PIMC_player
...
def test_vs_rule_player_pimc(
    ...
    alpha_player_0 = Heavy_PIMC_player(0, mcts_params, model)
    alpha_player_2 = Heavy_PIMC_player(2, mcts_params, model)
