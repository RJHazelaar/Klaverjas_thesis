...
class AlphaZero_player_master_split:
    def __init__(self, player_position: int, mcts_params: dict, model_value, model_policy, **kwargs):
        self.player_position = player_position
        self.model_value = model_value
        self.model_policy = model_policy
        self.mcts = MCTS(mcts_params, model_value, model_policy, player_position, time_limit=kwargs.get('time_limit'))
