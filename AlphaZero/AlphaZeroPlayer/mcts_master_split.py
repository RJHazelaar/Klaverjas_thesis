...
class MCTS_Node:
    ...
    def select_child_puct(self, c, simulation, root_team, state, model_policy):
        ...
        probabilities_legal = [1 / len(legal_moves) for x in probabilities_legal]
...
class MCTS:
    def __init__(self, params: dict, model_value, model_policy, player_position: int,  **kwargs):
        ...
        while time.time_ns() < ending_time:
            ...
            if not current_state.round_complete():
                ...
                if self.model_value is not None:
                    ...
                    now2 = time.time()
                    nn_score = int(self.model_value(arr))
    ...
    def mcts_n_simulations(self, state: State, training: bool, extra_noise_ratio, steps):
        ...
        for simulation in range(steps):
            ...
            while (
                ...
                new_node_move, new_node_node = current_node.select_child_puct(self.ucb_c, simulation, root_team, current_state, self.model_policy)
